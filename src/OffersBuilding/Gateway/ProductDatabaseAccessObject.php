...
final class ProductDatabaseAccessObject extends DatabaseAccessObject
{
    ...
    public function insert(array $rows): void
    {
        foreach (array_chunk($rows, self::ROWS_NUMBER_FOR_QUERY) as $chunk) {
            ...
            ON CONFLICT (kais_product_id, tradepoint_id)
            DO UPDATE SET
                assortment_unit_id           = excluded.assortment_unit_id,
