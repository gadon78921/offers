...
final class FilterByPackageQuantityExtractor implements FilterExtractorInterface
{
    /**
     ...
     *
     * @return array{packageQuantity: string}
     */
    public function extract(array $assortmentUnitSpecification): array
    {
        return ['packageQuantity' => $assortmentUnitSpecification['packageQuantity'] . ' шт.'];
    }
}
