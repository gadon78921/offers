...
final class FilterByManufacturerCountryNameExtractor implements FilterExtractorInterface
{
    /**
    ...
    {
        return ['country' => $assortmentUnitSpecification['manufacturerCountryName'] ?? 'не указана'];
    }
}
