...
final class FilterByActiveSubstanceExtractor implements FilterExtractorInterface
{
    /**
     ...
     *
     * @return array{activeSubstance: string}
     */
    public function extract(array $assortmentUnitSpecification): array
    {
        return ['activeSubstance' => $assortmentUnitSpecification['activeSubstance'] ?? 'не указано'];
    }
}
